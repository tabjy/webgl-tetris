...
class Tile extends GameObject {
  constructor () {
    ...
    this.rotationIdx = Math.floor(Math.random() * this.pattern.rotations.length)
    this.rotate()
  ...
  rotate () {
    this.rotationIdx = (this.rotationIdx + 1) % this.pattern.rotations.length
    this.transform.rotation = this.pattern.rotations[this.rotationIdx]
  }
}
